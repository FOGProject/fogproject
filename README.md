...
1. Download the file(s)
 ...
 - **tar/zip** `wget http://downloads.sourceforge.net/project/freeghost/FOG/1.3.5/fog_1.3.5.tar.gz | tar -xzfC fog_1.3.5/`
 - **SVN** ` svn checkout https://svn.code.sf.net/p/freeghost/code/tags/1.3.5/ fog_1.3.5/`
 - **git** ` git clone https://github.com/fogproject/fogproject.git fog_1.3.5/`
