...
#
[[ -z $packages ]] && packages="apache bc curl dhcp gcc gzip lftp m4 make mariadb mod_fastcgi net-tools nfs-utils openssh openssl perl perl-crypt-passwdmd5 php php-apache php-fpm php-gd php-mcrypt tar tftp-hpa vsftpd wget xinetd"
