...
#
[[ -z $packages ]] && packages="attr bc cdrtools curl dhcp gcc git gzip lftp m4 make mariadb mod_fastcgi net-tools nfs-utils openssh openssl perl perl-crypt-passwdmd5 php php-apache php-fpm php-gd php-ssh2 syslinux tar tftp-hpa vsftpd wget xinetd xz"
