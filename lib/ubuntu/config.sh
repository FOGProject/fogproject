...
if [[ $systemctl == yes ]]; then
    ...
    if [[ -e /lib/systemd/system/mariadb.service ]]; then
        ln -s /lib/systemd/system/mariadb.service /lib/systemd/system/mysql.service 2>>/var/log/fog_error_${version}.log 2>&1
        ln -s /lib/systemd/system/mariadb.service /lib/systemd/system/mysqld.service 2>>/var/log/fog_error_${version}.log 2>&1
        ln -s /lib/systemd/system/mariadb.service /etc/systemd/system/mysql.service 2>>/var/log/fog_error_${version}.log 2>&1
        ln -s /lib/systemd/system/mariadb.service /etc/systemd/system/mysqld.service 2>>/var/log/fog_error_${version}.log 2>&1
