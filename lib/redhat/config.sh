...
if [[ $systemctl == yes ]]; then
    ...
    if [[ -e /usr/lib/systemd/system/mariadb.service ]]; then
        ln -s /usr/lib/systemd/system/mariadb.service /usr/lib/systemd/system/mysql.service >>./error_logs/fog_error_${version}.log 2>&1
        ln -s /usr/lib/systemd/system/mariadb.service /usr/lib/systemd/system/mysqld.service >>./error_logs/fog_error_${version}.log 2>&1
        ln -s /usr/lib/systemd/system/mariadb.service /etc/systemd/system/mysql.service >>./error_logs/fog_error_${version}.log 2>&1
        ln -s /usr/lib/systemd/system/mariadb.service /etc/systemd/system/mysqld.service >>./error_logs/fog_error_${version}.log 2>&1
    elif [[ -e /usr/lib/systemd/system/mysqld.service ]]; then
        ln -s /usr/lib/systemd/system/mysqld.service /usr/lib/systemd/system/mysql.service >>./error_logs/fog_error_${version}.log 2>&1
        ln -s /usr/lib/systemd/system/mysqld.service /etc/systemd/system/mysql.service >>./error_logs/fog_error_${version}.log 2>&1
    fi
