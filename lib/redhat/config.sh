...
if [[ $systemctl == yes ]]; then
    ...
    if [[ -e /usr/lib/systemd/system/mariadb.service ]]; then
        ln -s /usr/lib/systemd/system/mariadb.service /usr/lib/systemd/system/mysql.service 2>>/var/log/fog_error_${version}.log 1>/dev/null 2>&1
        ln -s /usr/lib/systemd/system/mariadb.service /usr/lib/systemd/system/mysqld.service 2>>/var/log/fog_error_${version}.log 1>/dev/null 2>&1
        ln -s /usr/lib/systemd/system/mariadb.service /etc/systemd/system/mysql.service 2>>/var/log/fog_error_${version}.log 1>/dev/null 2>&1
        ln -s /usr/lib/systemd/system/mariadb.service /etc/systemd/system/mysqld.service 2>>/var/log/fog_error_${version}.log 1>/dev/null 2>&1
