            ...
            case $novhost in
                ...
                *)
                    ...
                    if [[ $httpproto == https ]]; then
                        ...
                        echo "    SSLProtocol all -SSLv3 -TLSv1 - TLSv1.1" >> "$etcconf"
                        echo "    SSLCipherSuite          ECDHE-ECDSA-AES128-GCM-SHA256:ECDHE-RSA-AES128-GCM-SHA256:ECDHE-ECDSA-AES256-GCM-SHA384:ECDHE-RSA-AES256-GCM-SHA384:ECDHE-ECDSA-CHACHA20-POLY1305:ECDHE-RSA-CHACHA20-POLY1305:DHE-RSA-AES128-GCM-SHA256:DHE-RSA-AES256-GCM-SHA384:DHE-RSA-CHACHA20-POLY1305" >> "$etcconf"
