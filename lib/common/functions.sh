...
configureMySql() {
    ...
    dbservice=$(systemctl list-units | grep -e mysql -e mariadb | awk '{print $1}')
    [[ -z $dbservice ]] && dbservice=$(systemctl list-unit-files | grep -e mysql -e mariadb | grep -v bad | awk '{print $1}')
