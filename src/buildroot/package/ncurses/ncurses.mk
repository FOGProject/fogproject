...
NCURSES_LIBS-y = libncurses${NCURSES_W}
NCURSES_LIBS-$(BR2_PACKAGE_NCURSES_TARGET_MENU) += libmenu$(NCURSES_W)
NCURSES_LIBS-$(BR2_PACKAGE_NCURSES_TARGET_PANEL) += libpanel$(NCURSES_W)
NCURSES_LIBS-$(BR2_PACKAGE_NCURSES_TARGET_FORM) += libform$(NCURSES_W)
