...
class TaskMobile extends FOGPage {
    ...
    public function __construct($name = '') {
        ...
        if (isset($_REQUEST['id'])) $this->obj = static::getClass('Task',$_REQUEST['id']);
    }
    ...
    public function active() {
        array_map(function(&$Task) {
            ...
            unset($Task);
        },(array)static::getClass($this->childClass)->getManager()->find(array('stateID'=>array_merge($this->getQueuedStates(),(array)$this->getProgressState()))));
        $this->render();
    }
}
