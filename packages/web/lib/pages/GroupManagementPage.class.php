...
class GroupManagementPage extends FOGPage {
    ...
    public function edit() {
        ...
        print '<form method="post" action="'.$this->formAction.'&tab=group-general"><div id="tab-container"><!-- General --><div id="group-general"><h2>'._('Modify Group').': '.$this->obj->get(name).'</h2>';
        ...
        print '<!-- Printers --><div id="group-printers"><form method="post" action="'.$this->formAction.'&tab=group-printers"><h2>'._('Select Management Level for all Hosts in this group').'</h2><p class="l"><input type="radio" name="level" value="0" />'._('No Printer Management').'<br/><input type="radio" name="level" value="1" />'._('Add Only').'<br/><input type="radio" name="level" value="2" />'._('Add and Remove').'<br/></p><div class="hostgroup">';
