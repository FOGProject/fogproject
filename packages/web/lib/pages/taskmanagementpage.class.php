...
class TaskManagementPage extends FOGPage {
    ...
    public function active_multicast_post() {
        ...
        $TaskIDs = static::getSubObjectIDs('MulticastSessionsAssociation',array('msID'=>$MulticastSessionIDs),'taskID');
    ...
    public function active_snapins_post() {
        ...
        $SnapinJobIDs = static::getSubObjectIDs('SnapinTask',array('id'=>$SnapinTaskIDs),'jobID');
        $SnapinJobIDs = static::getSubObjectIDs('SnapinTask',array('id'=>$SnapinTaskIDs),'jobID');
        $HostIDs = static::getSubObjectIDs('SnapinJob',array('id'=>(array)$SnapinJobIDs),'hostID');
        $TaskIDs = static::getSubObjectIDs('Task',array('hostID'=>$HostIDs));
        static::getClass('TaskManager')->cancel($TaskIDs);
