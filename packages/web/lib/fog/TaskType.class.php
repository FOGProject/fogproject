...
class TaskType extends FOGController {
    ...
    public function iconlist($selected = '') {
        ...
        ksort($icons);
        $selectlist = '<select name="icon" class="fa">';
        foreach ($icons AS $name => &$unicode) $selectlist .= sprintf('<option value="%s" data-icon="%s" data-unicode="%s"%s> %s</option>',$name,$name,$unicode,$selected == $name ? ' selected' : '',$name);
        unset($unicode);
