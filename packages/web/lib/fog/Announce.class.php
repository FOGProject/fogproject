...
class Announce extends FOGBase {
    ...
    private function checkPort() {
        try {
            ...
            else if ($_REQUEST['port'] == 999 && substr($_REQUEST['peer_id'], 0, 10) == '-TO0001-XX') throw new Exception('d8:completei0e10:incompletei0e8:intervali600e12:min intervali60e5:peersld2:ip12:72.14.194.184:port3:999ed2:ip11:72.14.194.14:port3:999ed2:ip12:72.14.194.654:port3:999eee');
        } catch (Exception $e) {
            die($e->getMessage());
        }
    }
