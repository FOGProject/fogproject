<?php
/** Class Name: FOGAssociation
	Extends FOGBase
	Gets the database associative fields
	and returns it's real class items.
*/
abstract class FOGAssociation extends FOGBase
{
	...
	public function __construct()
	{
		...
		if (!$this->isTableDefined())
			throw new Exception(_('No database table defined for this item!');
		if (!count($this->databaseFields))
			throw new Exception(_('No database fields defined for %s class!',get_class($this)));
		return $this;
	}
	/** istableDefined()
