...
abstract class FOGPage extends FOGBase
{
    ...
    /**
     * Sends an AJAX response with the given message and status code.
     *
     * @param string $message The message to send.
     * @param string $title The title for the response.
     * @param int $statusCode The HTTP status code.
     * @return void
     */
    protected function sendAjaxResponse(string $message, string $title, int $statusCode): void
    {
     ...
     *
     * @param Exception $e The exception thrown during the AJAX request.
     * @return void
     */
    protected function handleAjaxError(Exception $e): void
    {
    ...
    /**
     * Creates a JSON-encoded success message.
     *
     * @param string $message The message.
     * @param string $title The title.
     * @return string The JSON-encoded success message.
     */
    protected function createSuccessMessage(string $message, string $title): string
    {
        return json_encode([
            'msg' => $message,
            'title' => $title
    ...
    /**
     * Creates a JSON-encoded error message.
     *
     * @param string $errorMessage The error message.
     * @param string $title The title.
     * @return string The JSON-encoded error message.
     */
    protected function createErrorMessage(string $errorMessage, string $title): string
    {
        return json_encode([
            'error' => $errorMessage,
            'title' => $title
    ...
    /**
     * Sanitizes input values from POST.
     *
