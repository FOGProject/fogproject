...
class HookManager extends EventManager {
    ...
    public function getEvents() {
        ...
        array_map($fileRead,(array)iterator_to_array(static::getClass('RegexIterator',static::getClass('RecursiveIteratorIterator',static::getClass('RecursiveDirectoryIterator',BASEPATH,FileSystemIterator::SKIP_DOTS)),'/^.+\.php$/i',RecursiveRegexIterator::GET_MATCH)));
