...
class Service extends FOGController {
    ...
    public function remDir($dir) {$this->getClass('DirCleanerManager')->destroy(array('id' => $dir));}
    ...
    public function remGF($gf) {$this->getClass('GreenFogManager')->destroy(array('id' => $gf));}
    ...
    //Remove Cleanup user
    public function remUser($id) {$this->getClass('UserCleanup',$id)->destroy();}
}
