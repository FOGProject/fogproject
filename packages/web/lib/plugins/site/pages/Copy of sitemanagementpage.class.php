...
class AccessControlManagementPage extends FOGPage
{
    ...
    public function index()
    {
        ...
        foreach ((array)self::getClass('AccessControlManager')
            ...
            $this->data[] = array(
            	...
            	'isRestrictedSearch' => ($AccessControl->get('restrictedSearch') ?
            			_('Yes') :
            			_('No')
            			),
    ...
    public function add()
    {
        ...
        $fields = array(
        	...
        	_('Restricted searches by location') => sprintf(
        		'<input type="checkbox" name="isRestricted"%s/>',
        		(
        			isset($_REQUEST['isRestricted']) ?
        			' checked' :
        			''
        		)
        	),
    ...
    public function addPost()
    {
        try {
            ...
            $AccessControl = self::getClass('AccessControl')
                ...
                ->set('restrictedSearch', isset($_REQUEST['isRestricted']));
    ...
    public function edit()
    {
        ...
        $fields = array(
        	...
        	_('Restricted searches by location') => sprintf(
        		'<input type="checkbox" name="isRestricted"%s/>',
        		(
        			$this->obj->get('restrictedSearch') > 0 ?
        				' checked' :
        				''
        		)
        	),
