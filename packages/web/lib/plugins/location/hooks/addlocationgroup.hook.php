...
class AddLocationGroup extends Hook {
    ...
    public function GroupFields($arguments) {
        ...
        $locationID = static::getSubObjectIDs('LocationAssociation',array('hostID'=>$arguments['Group']->get('hosts')),'locationID');
        $locID = array_shift($locationID);
        $this->array_insert_after(_('Group Product Key'),$arguments['fields'],_('Group Location'),static::getClass('LocationManager')->buildSelectBox($locID));
    }
    public function GroupAddLocation($arguments) {
        ...
        static::getClass('LocationAssociationManager')->destroy(array('hostID'=>$arguments['Group']->get('hosts')));
