...
require_once("../lib/jpgraph/" . FOG_JPGRAPH_VERSION . "/src/jpgraph_gantt.php");
...
$graph->title->Set("Host Login History");
$graph->scale->day->SetStyle( DAYSTYLE_LONGDAYDATE2 );
$graph->scale->actinfo->SetColTitles(array('','Username'));
