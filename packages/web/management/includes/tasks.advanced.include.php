...
if ( $blIsHost )
{
	...
	echo ( "<tr><td class=\"leadingSpace bottomLightBorder\"><a href=\"?node=tasks&type=host&direction=inventory&noconfirm=" . $imageMembers->getID() ."\"><img class=\"advancedIcon\" src=\"./images/inventory.png\" /><p class=\"advancedTitle\">Hardware Inventory</p></a></td><td class=\"leadingSpace bottomLightBorder\"><p class=\"advancedDesc\">The hardware inventory task will boot the client computer and pull basic hardware informtation from it and report it back to the FOG server. </p></td></tr>" );									
	echo ( "</table>" );
}
else
{
	...
	echo ( "<tr><td class=\"leadingSpace bottomLightBorder\"><a href=\"?node=tasks&type=group&direction=inventory&noconfirm=" . $groupid ."\"><img class=\"advancedIcon\" src=\"./images/inventory.png\" /><p class=\"advancedTitle\">Hardware Inventory</p></a></td><td class=\"leadingSpace bottomLightBorder\"><p class=\"advancedDesc\">The hardware inventory task will boot the client computer and pull basic hardware informtation from it and report it back to the FOG server. </p></td></tr>" );	
	echo ( "</table>" );
}
