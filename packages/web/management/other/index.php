	...
	<?php if ($this->FOGUser) { ?><div id="mainContainer">
     ...
     ?><!-- FOG Message Boxes -->
				<div id="loader-wrapper"><div id="loader"></div><div id="progress"></div></div>
					...
					<div id="logo">
					<h1><a href="<?php echo htmlentities($_SERVER['PHP_SELF'],ENT_QUOTES,'UTF-8') ?>"><img src="<?php echo $this->imagelink ?>fog-logo.png" title="<?php echo $this->foglang['Home'] ?>" /><sup><?php echo FOG_VERSION ?></sup></a></h1>
