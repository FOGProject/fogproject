...
try {
    ...
    if (!$moduleID || !$moduleID->isValid()) {
        if ($_REQUEST[moduleid] == 'dircleaner' || $_REQUEST[moduleid] == 'dircleanup') $_REQUEST[moduleid] = array('dircleaner','dircleanup');
        if ($_REQUEST[moduleid] == 'snapin' || $_REQUEST[moduleid] == 'snapinclient') $_REQUEST[moduleid] = array('snapin','snapinclient');
