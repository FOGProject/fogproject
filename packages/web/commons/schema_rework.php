...
$this->schema[] = array(
    ...
    "CREATE TABLE IF NOT EXISTS `hosts` (
        ...
        `hostUseAD` ENUM('0','1') NOT NULL,
        `hostADDomain` VARCHAR(255) NOT NULL,
        `hostADOU` LONGTEXT NOT NULL,
        `hostADUser` VARCHAR(255) NOT NULL,
        `hostADPass` LONGTEXT NOT NULL,
        `hostADPassLegacy` LONGTEXT NOT NULL,
        `hostProductKey` VARCHAR(255) NOT NULL,
        `hostPrinterLevel` ENUM('0','1','2') NOT NULL,
        `hostKernelArgs` LONGTEXT NOT NULL,
        `hostKernel` LONGTEXT NOT NULL,
        `hostDevice` LONGTEXT NOT NULL,
        `hostInit` LONGTEXT NOT NULL,
        `hostPending` ENUM('0','1') NOT NULL,
        `hostPubKey` LONGTEXT NOT NULL,
        `hostSecToken` LONGTEXT NOT NULL,
        `hostSecTime` DATETIME NOT NULL,
        `hostPingCode` INTEGER NOT NULL,
    ...
    "CREATE TABLE IF NOT EXISTS `groups` (
        ...
        `groupUseAD` ENUM('0','1') NOT NULL,
        `groupADDomain` VARCHAR(255) NOT NULL,
        `groupADOU` LONGTEXT NOT NULL,
        `groupADUser` VARCHAR(255) NOT NULL,
        `groupADPass` LONGTEXT NOT NULL,
        `groupADPassLegacy` LONGTEXT NOT NULL,
        `groupProductKey` VARCHAR(255) NOT NULL,
        `groupPrinterLevel` ENUM('0','1') NOT NULL,
        `groupKernelArgs` LONGTEXT NOT NULL,
        `groupKernel` LONGTEXT NOT NULL,
        `groupDevice` LONGTEXT NOT NULL,
    ...
    "CREATE TABLE IF NOT EXISTS `images` (
        ...
        `imageCreateDate` DATETIME NOT NULL,
        `imageCreateBy` VARCHAR(40) NOT NULL,
        `imageLastUpload` DATETIME NOT NULL,
        `imagePath` VARCHAR(255) NOT NULL,
        `imageProtect` ENUM('0','1') NOT NULL,
        `imageReplicate` ENUM('0','1') NOT NULL,
    ...
    'CREATE TABLE IF NOT EXISTS `imagePartitionTypes` (
        ...
        `imagePartitionTypeDesc` LONGTEXT NOT NULL,
        `imagePartitionTypeCreateDate` DATETIME NOT NULL,
        `imagePartitionTypeCreateBy` VARCHAR(40) NOT NULL,
    ...
    'CREATE TABLE IF NOT EXISTS `os` (
        ...
        `osDesc` LONGTEXT NOT NULL,
        `osCreateDate` DATETIME NOT NULL,
        `osCreateBy` VARCHAR(40) NOT NULL,
