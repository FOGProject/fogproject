...
$foglang['StorageNode'] = _('Storage Node');
$foglang['StorageNodes'] = _('Storage Nodes');
$foglang['StorageGroup'] = _('Storage Group');
$foglang['StorageGroups'] = _('Storage Groups');
...
$foglang['ExportStoragenode'] = _('Export Storage Nodes');
$foglang['ImportStoragenode'] = _('Import Storage Nodes');
$foglang['ExportStoragegroup'] = _('Export Storage Groups');
$foglang['ImportStoragegroup'] = _('Import Storage Groups');
