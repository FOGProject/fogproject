...
$foglang['BandwidthRepHelp']        = _('This setting limits the bandwidth for replication between nodes.  It operates by getting the max bandwidth setting of the node it\'s transmitting to. So if you are trying to transmit to remote node A and node A only has a 5Mbps and you want the speed limited to 1Mbps on that node, you set the bandwidth field on that node to 1000.');
