...
* Documented LDAP nested-group limitation on 1.5 installs where the LDAP plugin predates Feb 2026 (no plugin-table migration path in 1.5); resolution is wontfix on 1.5 and upgrade to 1.6 (#892, #884)
